...
// Exact blue circular vehicle badge matching the user's reference image
export const CAR_CENTER_BADGE = `data:image/svg+xml;utf8,${encodeURIComponent(`
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
  <!-- Outer circular blue background with clean white border -->
  <circle cx="50" cy="50" r="46" fill="#1e40af" stroke="#ffffff" stroke-width="6"/>
  
  <!-- Vehicle Icon matching the screenshot -->
  <g fill="none" stroke="#ffffff" stroke-width="5.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- Front and rear wheel cuts -->
    <path d="M26 56 L30 56" />
    <path d="M42 56 L60 56" />
    <path d="M72 56 L79 56" />
    <!-- Front and Rear Wheels -->
    <circle cx="36" cy="56" r="6" fill="#1e40af" stroke="#ffffff" stroke-width="5" />
    <circle cx="66" cy="56" r="6" fill="#1e40af" stroke="#ffffff" stroke-width="5" />
    <!-- Window divider -->
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${className}`}>
      <QRCodeSVG
        value={value}
        size={size}
        level="H" // High error correction level ensures 100% scan reliability with center logo
